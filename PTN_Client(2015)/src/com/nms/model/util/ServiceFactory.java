...
public class ServiceFactory {
	...
	private ObjectService_Mybatis getService_MB(int services, SqlSession sqlSession) {
		...
		case Services.ALARMVOICE:
			AlarmVoiceService_MB voiceService = new AlarmVoiceService_MB();
			voiceService.setPtnuser(ptnuser);
			voiceService.setSqlSession(sqlSession);
			voiceService.setMapper(sqlSession.getMapper(AlarmVoiceInfoMapper.class));
			return voiceService;
