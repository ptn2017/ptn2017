...
,PTPPORTSTATUS(715),PTPBASICSTATUS(716),QUERY_LOCAL_SN(717),QUERY_ADJOIN_SN(718),QUERY_REMOTE_SN(719),SET_REMOTE_IP(720),SET_LOCAL_SN(721),SET_REMOTE_SN(722),SET_LOCAL_IP(723),SELECTSITE(724),
INSERTBFD(725),UPDATEBFD(726),DELETEBFD(727),SYNCBFD(728),DONDELETEBFD(729),BFDSELECT(730),BFDERROR1(731),PWBFDERROR1(732),ADDARP(733),UPDATEARP(734),DELETEARP(735),SYNCHROARP(736),ARPSELECT(737),
ALARMCONFIRM(738),ALARMCLEAN(739),SETLOCATION(740),FIELDUPDATE(741),DATABASEBACK(742),DATABASERECOVIE(743),SEGMENTSELECT(744),SEGMENTCLEARSELECT(745),LOGSELECT(746),LOGCLEARSELECT(747),LOGREMOVE(748),OPERAIONLOGSELECT(749),OPERAIONLOGCLEARSELECT(750),OPERATIONLOGCLEAR(751),MOVESITE(752),UPGRADCANCLE(753),
MACLEARNINGSYNC(754),PATHWIDTH(755),LSPPORTEXPORT(756),PATHNUM(757),NEPATHCOUNT(758),DATAANALYSISI(763),UPDATELOGMANAGER(764),DELETELOG(765);
	...
	public String toString(){
		...
		case 108:
			return ResourceUtil.srcStr(StringKeysTitle.TIT_UPDATE_PORT_AGGREGATION);//新建LAG
		case 109:
		...
		case 193:
			return ResourceUtil.srcStr(StringKeysMenu.MENU_PORT_DELETE_VLAN);//删除所有端口的所有VLAN
		case 194:
			return ResourceUtil.srcStr(StringKeysMenu.MENU_PORT_CONTAIN_VLAN);//端口丢弃流设置
		case 195:
		...
		case 717: 
			return ResourceUtil.srcStr(StringKeysMenu.MENU_QUERY_LOCATION_SN);//查询本地网元SN
		case 718: 
			return ResourceUtil.srcStr(StringKeysMenu.MENU_QUERY_ADJOIN_SN);//查询相邻网元SN
		case 719: 
			return ResourceUtil.srcStr(StringKeysMenu.MENU_QUERY_REMOTE_SN);//查询远程网元SN
		case 720: 
			return ResourceUtil.srcStr(StringKeysMenu.MENU_SET_REMOTE_IP);//设置远程网元IP
		case 721: 
			return ResourceUtil.srcStr(StringKeysMenu.MENU_SET_LOCAL_SN);//设置本地网元SN
		case 722: 
			return ResourceUtil.srcStr(StringKeysMenu.MENU_SET_REMOTE_SN);//设置远程网元SN
		case 723: 
			return ResourceUtil.srcStr(StringKeysMenu.MENU_SET_LOCAL_IP);//设置本地网元SN
		case 724: 
			return ResourceUtil.srcStr(StringKeysMenu.MENU_SELECTSITE);//定位网元
		case 725: 
			return ResourceUtil.srcStr(StringKeysMenu.MENU_INSERT_BFD);//新建bfd
		case 726: 
			return ResourceUtil.srcStr(StringKeysMenu.MENU_UPDATE_BFD);//修改bfd
		case 727: 
			return ResourceUtil.srcStr(StringKeysMenu.MENU_DELETE_BFD);//删除bfd
		case 728: 
			return ResourceUtil.srcStr(StringKeysMenu.MENU_SYNC_BFD);//同步bfd
		case 729: 
			return ResourceUtil.srcStr(StringKeysTip.TIP_DCBFDNOT_DELETEONLINE);//在线托管bfd
		case 730: 
			return ResourceUtil.srcStr(StringKeysTip.TIP_BFD_SELECT);//bfd状态查询	
		case 731: 
			return ResourceUtil.srcStr(StringKeysTip.TIP_BFD_ERROR);//存在BFD	
		case 732: 
			return ResourceUtil.srcStr(StringKeysTip.TIP_PWBFD_ERROR);//PW存在BFD	
		case 733:
			return ResourceUtil.srcStr(StringKeysTitle.TIT_CREATE_ARP);//新建arp
		case 734:
			return ResourceUtil.srcStr(StringKeysTitle.TIT_UPDATE_ARP);//修改arp
		case 735:
			return ResourceUtil.srcStr(StringKeysTitle.TIT_DELETE_ARP);//删除arp
		case 736:
			return ResourceUtil.srcStr(StringKeysTitle.TIT_SYNCHRO_ARP);//同步arp
		case 737:
			return ResourceUtil.srcStr(StringKeysTitle.TIT_SELECT_ARP);//查询arp
		case 738:
			return ResourceUtil.srcStr(StringKeysBtn.BTN_AFFIRM_ALARM);//告警确认
		case 739:
			return ResourceUtil.srcStr(StringKeysBtn.BTN_CLEAR_ALARM);//告警清除
		case 740:
			return ResourceUtil.srcStr(StringKeysMenu.MENU_SET_TO_LOCAL_NE);//设置为本地网元
		case 741:
			return ResourceUtil.srcStr(StringKeysTitle.TIT_UPDATE_FIELD);//修改域
		case 742:
			return ResourceUtil.srcStr(StringKeysTip.TIP_DATABASE_BACKS);//数据备份
		case 743:
			return ResourceUtil.srcStr(StringKeysTip.TIP_DATABASE_RECOVER);//数据恢复
		case 744:
			return ResourceUtil.srcStr(StringKeysTip.TIP_SEGMENT_SELECT);//段设置过滤
		case 745:
			return ResourceUtil.srcStr(StringKeysTip.TIP_SEGMENT_CLEARSELECT);//段清除过滤	
		case 746:
			return ResourceUtil.srcStr(StringKeysTip.TIP_LOG_SELECT);//登录日志设置过滤
		case 747:
			return ResourceUtil.srcStr(StringKeysTip.TIP_LOG_CLEARSELECT);//登录日志清除过滤
		case 748:
			return ResourceUtil.srcStr(StringKeysTip.TIP_LOG_REMOVE);//登录日志移除
		case 749:
			return ResourceUtil.srcStr(StringKeysTip.TIP_OPEARTIONLOG_SELECT);//操作日志设置过滤
		case 750:
			return ResourceUtil.srcStr(StringKeysTip.TIP_OPEARTIONLOG_CLEARSELECT);//操作日志清除过滤
		case 751:
			return ResourceUtil.srcStr(StringKeysTip.TIP_OPEARTIONLOG_CLEAR);//操作日志清除数据
		case 752:
			return ResourceUtil.srcStr(StringKeysTip.TIP_MOVE_SITE);//移动网元
		case 753:
			return ResourceUtil.srcStr(StringKeysTip.TIP_CANCLE_UPGRADE);//取消升级
		case 754:
			return ResourceUtil.srcStr(StringKeysTip.TIP_MACLEARNING_SYNC);//MAC地址学习同步
		case 755:
			return ResourceUtil.srcStr(StringKeysTip.TIP_PATH_WIDTH);//MAC地址学习同步
		case 756:
			return ResourceUtil.srcStr(StringKeysTip.TIP_LSPPORT_EXPORT);
		case 757:
			return ResourceUtil.srcStr(StringKeysTip.TIP_PATH_NUM);
		case 758:
			return ResourceUtil.srcStr(StringKeysTip.TIP_NEPATH_COUNT);
		case 763:
			return ResourceUtil.srcStr(StringKeysTip.TIP_ANALYSIS_UPDATE);	
		case 764:
			return ResourceUtil.srcStr(StringKeysTip.TIP_UPDATE_LOGMANAGER);
		case 765:
			return ResourceUtil.srcStr(StringKeysTip.TIP_DELETE_LOG);	
		default :
			return "";
		}
	}
