			    	 ...
			    	 if(etreeInfoList!=null && etreeInfoList.size()!=0){				    		
			    	     ...
			    	     if(etreeInfoList.get(0).getRootSite() == etreeInfoList.get(0).getaSiteId()){
			    		    ...
			    		    for(int i=0;i<zsiteIdList.size();i++){
			    		    	...
			    		    	zacInList = new ArrayList<Integer>();
			    		    	List<EtreeInfo> list=etreeService.selectAcIds(serviceType,name,zsiteIdList.get(i));
			    		    	if(list!=null && list.size()!=0 ){
			    		    	    String  zMostAcIds=list.get(0).getZmostAcId();
			           ...
			           if(etreeInfoList.get(0).getRootSite() != etreeInfoList.get(0).getaSiteId()){
				    		 ...
				    		 for(int i=0;i<asiteIdList.size();i++){
			    		    	 ...
			    		    	 List<EtreeInfo> list=etreeService.selectAcIds(serviceType,name,asiteIdList.get(i));	
			    		    	 if(list!=null && list.size()!=0){
			    		    		 String  aMostAcIds=list.get(0).getZmostAcId();
