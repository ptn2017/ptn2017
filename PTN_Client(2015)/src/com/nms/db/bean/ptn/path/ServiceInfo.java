...
public class ServiceInfo extends ViewDataObj{
	...
	private String Node = "Node";//log日志显示使用
	private int id;
	...
	private String name;
	private String pwName;//log日志显示使用
	private String aAcName;//log日志显示使用
	private String zAcName;//log日志显示使用
	private String clientName;//log日志显示使用
...
//	private AcPortInfo beforeZAc=null;	//修改之前的z端AC对象
	...
	public String getzAcName() {
		return zAcName;
	}
	public void setzAcName(String zAcName) {
		this.zAcName = zAcName;
	}
