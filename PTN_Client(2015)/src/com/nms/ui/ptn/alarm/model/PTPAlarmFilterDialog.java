 ...
 *
 */
public class PTPAlarmFilterDialog extends PtnDialog{
	/**
	 * 
	 */
	...
	private PTPAlarmController duanAlarmController;
	/**
	 * 实例化对象
	 */
	public PTPAlarmFilterDialog(PTPAlarmController duanAlarmController) {
	...
	private void addListener() {
		...
		cancel.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent arg0) {
				PTPAlarmFilterDialog.this.dispose();
			}
		});
