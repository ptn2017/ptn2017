...
import com.nms.ui.ptn.alarm.controller.PTPAlarmController;
 ...
 * 
 */
public class PTPAlarmPanel extends JPanel {
...
//	private JButton exportButton;// 导出按钮
	...
	public  PTPAlarmController controller;
...
//	private JButton btnAffirm;
	...
	public void init() {
		...
		setLayout();
		addListention();
		controller = new PTPAlarmController(this);
	}
...
//	}
	...
	public PTPAlarmController getController() {
		return controller;
	}

	public void setController(PTPAlarmController controller) {
