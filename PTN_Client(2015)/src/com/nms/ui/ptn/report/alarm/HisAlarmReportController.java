...
/**
 */
public class HisAlarmReportController {
	private HisAlarmReportPanel view;
	...
	public HisAlarmReportController(HisAlarmReportPanel view) {
		this.view = view;
		this.init();
	}
		...
		filterDialog.getConfirm().addActionListener(new MyActionListener() {
			...
			public void actionPerformed(ActionEvent evt) {
				if (filterDialog.validateParams()) {
					HisAlarmReportController.this.setFilter(filterDialog);
				}
			}
			@Override
...
//		}
	...
	public HisAlarmReportPanel getView() {
		return view;
	}
