 ...
 *
 */
public class SystemLogFilterDialog extends PtnDialog{
	/**
	 * 
	 */
	...
	private void addListener() {
		...
		cancel.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent arg0) {
				SystemLogFilterDialog.this.dispose();
			}
		});
	}
	private void initComponents() {
		...
		operationResultBox.addItem("全部");
		operationResultBox.addItem("MYSQL5服务");
		operationResultBox.addItem("北向接口服务");
		operationResultBox.addItem("告警轮询");		
