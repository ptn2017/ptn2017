...
/**
 */
public class ElanBusinessCountPanel extends ContentView<ElanInfo>{
	/**
	 * 
	 */
	...
	public ElanBusinessCountPanel() {
		super("elanBusinessTable",RootFactory.COUNTMODU);
		init();
	}

	public void init() {
		getContentPanel().setBorder(BorderFactory.createTitledBorder(ResourceUtil.srcStr(StringKeysTab.TAB_ELAN_COUNT)));
		initComponent();
		setLayout();
		setActionListention();
	}
	...
	public void setController() {
		controller = new ElanBusinessCountController(this);
	}
