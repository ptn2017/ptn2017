 ...
 *
 */
public class PerformanceFileDialog1 extends PtnDialog {
	...
	public PerformanceFileDialog1(PerformanceInfoPanel view) {
		this.view=view;
		this.setModal(true);
		this.init();
	...
	private void addListener() {
		...
		cancel.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent arg0) {
				PerformanceFileDialog1.this.dispose();
			}
		});
		...
		clear.addActionListener(new ActionListener() {
			@Override
			public void actionPerformed(ActionEvent arg0) {
				PerformanceFileDialog1.this.clear();
			}
		});
		...
		confirm.addActionListener(new MyActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				 ...
				 */
				try {
					List<Element> portElement=PerformanceFileDialog1.this.neTreePanel.getElement();
					if(portElement!=null&&portElement.size()>0){
						...
						if(count == 0){
						DialogBoxUtil.succeedDialog(PerformanceFileDialog1.this, ResourceUtil.srcStr(StringKeysTip.TIP_PERFORMANCEPORT_MAX));
						count=0;
						return;
						}
						if(count>35){
							DialogBoxUtil.succeedDialog(PerformanceFileDialog1.this, ResourceUtil.srcStr(StringKeysTip.TIP_PERFORMANCE_MAX));
							count=0;
							return;
						}
						count=0;
					...
					if(selectEndTime.getSelectedItem().equals(newTime)){
						...
						if("0".equals(value)){
							DialogBoxUtil.succeedDialog(PerformanceFileDialog1.this, ResourceUtil.srcStr(StringKeysTip.TIP_INPUT_OVERTIME));
							return;
						}
					}
					view.setCode(Integer.parseInt(value));
					if(portElement == null || portElement.size() == 0){
						JOptionPane.showMessageDialog(PerformanceFileDialog1.this, ResourceUtil.srcStr(StringKeysTip.TIP_CHOOSE_PERFORMANCE_TYPE));
						return ;
					}
//					view.bingData(portElement);
					...
					ExceptionManage.dispose(e1, PerformanceFileDialog1.class);
				}
