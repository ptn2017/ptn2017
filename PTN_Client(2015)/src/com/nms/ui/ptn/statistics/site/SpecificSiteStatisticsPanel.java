 ...
 *
 */
public class SpecificSiteStatisticsPanel extends ContentView<SSSiteInst>{
	...
	public SpecificSiteStatisticsPanel(int fileId) {
		super("SiteInfoPanel",RootFactory.COUNTMODU);
		try {
			this.fileId = fileId;
			init();
		} catch (Exception e) {
	...
	public void setController() {
		controller = new SpecificSiteStatisticsPanelController(this);
	}
