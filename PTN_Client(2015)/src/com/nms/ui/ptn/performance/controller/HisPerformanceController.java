 ...
 * 
 */
public class HisPerformanceController extends AbstractController {
	
	private HisPerformancePanel view;
	...
	public HisPerformanceController(HisPerformancePanel view) {
		this.view = view;
		this.init();
	}
	...
	public void openFilterDialog() {
		...
		filterDialog.getConfirm().addActionListener(new MyActionListener() {
			...
			public void actionPerformed(ActionEvent evt) {
				try {
					HisPerformanceController.this.setFilter(filterDialog);
				} catch (Exception e) {
...
//		}
	...
	public HisPerformancePanel getView() {
		return view;
	}
