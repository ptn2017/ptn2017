 ...
 *
 */
public class WUPwRoatePanel extends JPanel{
	 ...
	 *    false  Z 端
	 */
	public WUPwRoatePanel(PwInfo pwInfo,boolean flag) {
		this.pw=pwInfo;
		this.flag=flag;
		this.initComponent();
		setRainValue();
	...
	public void setRainValue(){
		...
		try{
			...
			if (flag) {
				siteRoate.setSiteId(pw.getASiteId());
			} else {
				siteRoate.setSiteId(pw.getZSiteId());
			}
			siteRoate.setTypeId(pw.getPwId());
