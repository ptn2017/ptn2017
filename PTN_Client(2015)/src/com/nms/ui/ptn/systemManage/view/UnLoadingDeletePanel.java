 ...
 *
 */
public class UnLoadingDeletePanel extends ContentView<UnLoading> {
	...
	public UnLoadingDeletePanel() {
		super("unloadingDeletePanel",RootFactory.SYSTEM_MANAGE);
		init();		
	}
	public void init(){	
		try{			
	...
	public void setController() {
		controller = new UnLoadingController(this,2);	
	}
