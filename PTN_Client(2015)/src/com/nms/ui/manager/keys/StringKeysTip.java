...
public class StringKeysTip {
	...
	public static final String TIP_IP_MESSAGE="TIP_IP_MESSAGE";
	//业务被静态单播所用，不能修改
	public static final String TIP_UPDATE_NOT="TIP_UPDATE_NOT";
	public static final String TIP_DELETE_NOT="TIP_DELETE_NOT";
	public static final String TIP_VLANID_OVER="TIP_VLANID_OVER";
	/**
	 * 请手动备份数据,如果操作失败,请手动恢复数据
	 */
	public static final String TIP_BACK_UP_DATA = "TIP_BACK_UP_DATA";
	/**
	 * 数据回滚失败,请手动恢复数据,并进行数据下载操作
	 */
	public static final String TIP_ROLLBACK_FAIL_RECOVER_DATA = "TIP_ROLLBACK_FAIL_RECOVER_DATA";
	
	//bfd Lsp类型的LSP不能为空
	public static final String TIP_BFD_NOT_EMPTY_LSP="TIP_BFD_NOT_EMPTY_LSP";
	//bfd Lsp+pw类型的pw+LSP不能为空
	public static final String TIP_BFD_NOT_EMPTY_LSPPW="TIP_BFD_NOT_EMPTY_LSPPW";
	//VLANID必须为数字
	public static final String TIP_BFD_VLANID_NUMBER="TIP_BFD_VLANID_NUMBER";
	//VLAN的范围
	public static final String TIP_BFD_VLANID="TIP_BFD_VLANID";
	//UDP PORT 为一个数
	public static final String TIP_BFD_UDPPORT_NUMBER="TIP_BFD_UDPPORT_NUMBER";
	//udp port范围
	public static final String TIP_BFD_UDPPORT="TIP_BFD_UDPPORT";
	//MYSID 为整数
	public static final String TIP_BFD_MYSID_NUMBER="TIP_BFD_MYSID_NUMBER";
	//MYSID范围
	public static final String TIP_BFD_MYSID="TIP_BFD_MYSID";
	//PEERSID 为整数
	public static final String TIP_BFD_PEERSID_NUMBER="TIP_BFD_PERSID_NUMBER";
	//PEERSID范围
	public static final String TIP_BFD_PEERSID="TIP_BFD_PEERSID";
	
	//DECTMUI 为整数
	public static final String TIP_BFD_DECTMUI_NUMBER="TIP_BFD_DECTMUI_NUMBER";
	//DECTMUI范围
	public static final String TIP_BFD_DECTMUI="TIP_BFD_DECTMUI";
	//PWTLL 为整数
	public static final String TIP_BFD_PWTLL_NUMBER="TIP_BFD_PWTLL_NUMBER";
	//PWTLL范围
	public static final String TIP_BFD_PWTLL="TIP_BFD_PWTLL";	
	//在线托管不能删
	public static final String TIP_DCBFDNOT_DELETEONLINE="TIP_DCBFDNOT_DELETEONLINE";
	//本端会话标识符已存在
	public static final String TIP_BFD_MYSID_HAVE="TIP_BFD_MYSID_HAVE";
	//对端会话标识符已存在
	public static final String TIP_BFD_PEERSID_HAVE="TIP_BFD_PEERSID_HAVE";
	//本地IP必须为IP格式
	public static final String TIP_BFD_LOCALIPMATCH="TIP_BFD_LOCALIPMATCH";
	//远端IP必须为IP格式
	public static final String TIP_BFD_PEERIPMATCH="TIP_BFD_PEERIPMATCH";
	//BFD状态查询
	public static final String TIP_BFD_SELECT="TIP_BFD_SELECT";
	//BFD PW限制
	public static final String TIP_BFD_PWCOUNT="TIP_BFD_PWCOUNT";
	//BFD lsp限制
	public static final String TIP_BFD_LSPCOUNT="TIP_BFD_LSPCOUNT";
	//bfd 数量限制
	public static final String TIP_BFD_EMPTY="TIP_BFD_EMPTY";
	//前向入标签和后向入标签不能相同
	public static final String TIP_FRONTLABEL_BACKLABEL_IS_SAME="TIP_FRONTLABEL_BACKLABEL_IS_SAME";
	//TUNNEL删除被BFD使用
	public static final String TIP_BFD_ERROR="TIP_BFD_ERROR";
	//业务被BFD使用
	public static final String TIP_CLEAN_BFD="TIP_CLEAN_BFD";
	//PW删除被BFD使用
	public static final String TIP_PWBFD_ERROR="TIP_PWBFD_ERROR";

	//ADMIN密码长度必须在5-18之间
	public static final String MESSAGE_ADMIN_PASSWORD_LENG = "MESSAGE_ADMIN_PASSWORD_LENG";
	//确认恢复吗？
	public static final String TIP_IS_RECOVER = "TIP_IS_RECOVER"; 

	
	/**
	 * 	有子网在组中，不能删除
	 */
	public static final String TIP_SUB_DELETE_NODE = "TIP_SUB_DELETE_NODE";
	
	/**
	 * 	有网元在子网中，不能删除
	 */
	public static final String TIP_SUBNET_DELETE_NODE1 = "TIP_SUBNET_DELETE_NODE1";
	/**
	 * 请新建双规保护配置,并保证该网元是源节点
	 */
	public static final String TIP_ADD_DUAL_AND_IS_SOURCE = "TIP_ADD_DUAL_AND_IS_SOURCE";
	/**
	 * 请先删除相应的ARP配置
	 */
	public static final String TIP_DELETE_ARP = "TIP_DELETE_ARP";
	/**
	 * 请选择告警名称！
	 */
	public static final String TIP_CHOOSE_ALARM_DETAIL = "TIP_CHOOSE_ALARM_DETAIL";
	//数据备份
	public static final String TIP_DATABASE_BACKS="TIP_DATABASE_BACKS";
	//数据恢复
	public static final String TIP_DATABASE_RECOVER="TIP_DATABASE_RECOVER";
	//段层过滤
	public static final String TIP_SEGMENT_SELECT="TIP_SEGMENT_SELECT";
	//段层清除过滤
	public static final String TIP_SEGMENT_CLEARSELECT="TIP_SEGMENT_CLEARSELECT";
	//登录日志设置过滤
	public static final String TIP_LOG_SELECT="TIP_LOG_SELECT";
	//登录日志清除过滤
	public static final String TIP_LOG_CLEARSELECT="TIP_LOG_CLEARSELECT";
	//登录日志移除
	public static final String TIP_LOG_REMOVE="TIP_LOG_REMOVE";
	//在线用户注销
	public static final String TIP_LOG_OUT="TIP_LOG_OUT";
	//操作日志设置过滤
	public static final String TIP_OPEARTIONLOG_SELECT="TIP_OPEARTIONLOG_SELECT";
	//操作日志清除过滤
	public static final String TIP_OPEARTIONLOG_CLEARSELECT="TIP_OPEARTIONLOG_CLEARSELECT";
	//操作日志清除数据
	public static final String TIP_OPEARTIONLOG_CLEAR="TIP_OPEARTIONLOG_CLEAR";
	//移动网元
	public static final String TIP_MOVE_SITE="TIP_MOVE_SITE";
	//MAC地址学习同步
	public static final String TIP_MACLEARNING_SYNC="TIP_MACLEARNING_SYNC";
	//告警声音
	public static final String TIP_ALARM_SOUND="TIP_ALARM_SOUND";
	//服务路径带宽
	public static final String TIP_PATH_WIDTH="TIP_PATH_WIDTH";
	//链路带宽
	public static final String TIP_LSPPORT_EXPORT="TIP_LSPPORT_EXPORT";
	//端到端路径数量
	public static final String TIP_PATH_NUM="TIP_PATH_NUM";
	//网元路径数量统计导出
	public static final String TIP_NEPATH_COUNT="TIP_NEPATH_COUNT";
	public static final String TIP_NO_SN_NOTSUPPORT="TIP_NO_SN_NOTSUPPORT";
	public static final String TIP_NEW_SN_LENGTH="TIP_NEW_SN_LENGTH";
